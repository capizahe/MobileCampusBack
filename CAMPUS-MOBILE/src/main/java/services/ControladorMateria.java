...
public class ControladorMateria {
	...
	public @ResponseBody String agregarMateria(@RequestParam String nombre, @RequestParam Integer cant_creditos,
			@RequestParam String programa) {
		Optional<Programa> programa_ = repositorioProgramaDao.findProgramaByNombre(nombre);
		if (repositorioMateriasDao.findMateriaByNombre(nombre).isPresent())
			return "La materia " + nombre + " ya se encuentra agregada";
